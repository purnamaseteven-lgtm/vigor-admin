...
export function renderSidebar() {
    ...
    if (sectionActive('home')) {
        html += `<div class="sidebar-menu-label">Main Menu</div>`;
        html += `
        <div class="nav-item">
    ...
    if (sectionActive('master')) {
        html += `
        <div class="nav-item">
            <div class="nav-link" onclick="toggleMenu('masterMenu', this)"><i class="fa-solid fa-user-shield nav-icon"></i><span class="nav-label">Master</span><i class="fa-solid fa-chevron-right nav-arrow"></i></div>
            <div class="nav-submenu" id="masterMenu">
                <div class="nav-link" style="${check('master', 'whitelist') ? '' : 'display:none'}" onclick="go('whitelist')"><i class="fa-solid fa-check-circle nav-icon"></i><span class="nav-label">Whitelist</span></div>
                <div class="nav-link" style="${check('master', 'blacklist') ? '' : 'display:none'}" onclick="go('blacklist')"><i class="fa-solid fa-ban nav-icon"></i><span class="nav-label">Blacklist</span></div>
                <div class="nav-link" style="${check('master', 'masterWhitelist') ? '' : 'display:none'}" onclick="go('master-whitelist')"><i class="fa-solid fa-shield-halved nav-icon"></i><span class="nav-label">Master Whitelist</span></div>
            </div>
        </div>`;
    }

    // 3. Administrators & Company
    if (sectionActive('administrators')) {
        html += `
        <div class="nav-item">
            <div class="nav-link" onclick="toggleMenu('adminMenu', this)"><i class="fa-solid fa-users-gear nav-icon"></i><span class="nav-label">Administrators</span><i class="fa-solid fa-chevron-right nav-arrow"></i></div>
            <div class="nav-submenu" id="adminMenu">
                <div class="nav-link" style="${check('administrators', 'systemAdmins') ? '' : 'display:none'}" onclick="secureGo('admin-management')"><i class="fa-solid fa-user-lock nav-icon"></i><span class="nav-label">System Admins</span></div>
                <div class="nav-link" style="${check('administrators', 'rolePermissions') ? '' : 'display:none'}" onclick="go('dev-menu-config')"><i class="fa-solid fa-id-badge nav-icon"></i><span class="nav-label">Role Permissions</span></div>
            </div>
        </div>`;
    }
    ...
    if (sectionActive('companyManagement')) {
        html += `
        <div class="nav-item">
            <div class="nav-link" onclick="toggleMenu('compMenu', this)"><i class="fa-solid fa-building nav-icon"></i><span class="nav-label">Company</span><i class="fa-solid fa-chevron-right nav-arrow"></i></div>
            <div class="nav-submenu" id="compMenu">
                <div class="nav-link" style="${check('companyManagement', 'whitelabelList') ? '' : 'display:none'}" onclick="go('company-list')"><i class="fa-solid fa-list nav-icon"></i><span class="nav-label">Whitelabel List</span></div>
                <div class="nav-link" style="${check('companyManagement', 'regisNewCompany') ? '' : 'display:none'}" onclick="go('company-create')"><i class="fa-solid fa-plus nav-icon"></i><span class="nav-label">Regis New Company</span></div>
            </div>
        </div>`;
    }
    ...
    if (sectionActive('whitelabel')) {
        html += `
        <div class="nav-item">
            <div class="nav-link" onclick="toggleMenu('wlMenu', this)"><i class="fa-solid fa-tag nav-icon"></i><span class="nav-label">Whitelabel</span><i class="fa-solid fa-chevron-right nav-arrow"></i></div>
            <div class="nav-submenu" id="wlMenu">
                <div class="nav-link" style="${check('whitelabel', 'whitelabelList') ? '' : 'display:none'}" onclick="go('whitelabel-list')"><i class="fa-solid fa-list nav-icon"></i><span class="nav-label">Whitelabel List</span></div>
                <div class="nav-link" style="${check('whitelabel', 'masterWlList') ? '' : 'display:none'}" onclick="go('master-whitelabel-list')"><i class="fa-solid fa-crown nav-icon"></i><span class="nav-label">Master WL List</span></div>
            </div>
        </div>`;
    }
        ...
        if (sectionActive('customization')) {
            ...
            <div class="nav-item">
                    ...
                    <div class="nav-submenu" id="customMenu">
                        ...
                        <div class="nav-link" style="${check('customization', 'promotions') ? '' : 'display:none'}" onclick="go('custom-promotion-list')"><i class="fa-solid fa-bullhorn nav-icon"></i><span class="nav-label">Promotions</span></div>
